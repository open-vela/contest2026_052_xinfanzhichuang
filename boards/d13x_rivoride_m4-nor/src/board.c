...
#ifndef AIC_CHIP_D13X
#ifdef AIC_SRAM_SW_EN
    {MEM_SRAM_SW, "heap_sram_sw", (void *)&__sram_sw_heap_start,
     (void *)&__sram_sw_heap_end},
#endif
#ifdef AIC_SRAM_CMA_EN
    {MEM_SRAM_CMA, "heap_sram_cma", (void *)&__sram_cma_heap_start,
     (void *)&__sram_cma_heap_end},
#endif
#endif
...
void show_board_version(void) { printf("Board: %s\n\n", PRJ_BOARD); }
