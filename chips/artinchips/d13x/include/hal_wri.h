...
#ifndef __ARTINCHIP_HAL_WRI_D13X_H__
#define __ARTINCHIP_HAL_WRI_D13X_H__
...
#define BOOT_INFO_SET(val, mask, shift, cur)                                   \
  writel_bits(val, mask, shift, REG_BOOT_INFO)
#define BOOT_INFO_GET(mask, shift, cur)                                        \
  ({ cur = readl_bits(mask, shift, REG_BOOT_INFO); })
...
#define WRI_REBOOT_REASON_SHIFT 4
    ...
    defined(AIC_WRI_DRV_V10) || defined(AIC_WRI_DRV_V16)
