...
#include "../d12x/include/hal_xspi.h"
#elif defined(CONFIG_ARCH_CHIP_D13X)
#include "../d13x/include/hal_xspi.h"
#endif
...
int hal_xspi_set_addr_width(hal_xspi_handle *h, u8 ddr_sdr_mode, u8 lines,
                            u8 bw_3_4_bytes);
int hal_xspi_set_addr(hal_xspi_handle *h, u8 addr);
int hal_xspi_set_dummy(hal_xspi_handle *h, u8 lines, u8 dummy);
int hal_xspi_set_write_cnt(hal_xspi_handle *h, u8 ddr_sdr_mode, u8 lines,
                           u32 count);
int hal_xspi_set_read_cnt(hal_xspi_handle *h, u8 ddr_sdr_mode, u8 lines,
                          u32 count);
...
int hal_xspi_dll_training(hal_xspi_handle *h, u8 sel, u8 reg_icp,
