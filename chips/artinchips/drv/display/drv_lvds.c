...
static void lvds_set_mode(struct aic_lvds_comp *comp, struct panel_lvds *lvds) {
...
static void lvds_set_option_config(struct aic_lvds_comp *comp,
                                   struct panel_lvds *lvds) {
...
static int aic_lvds_probe(void) {
  ...
  comp = (struct aic_lvds_comp *)kmm_zalloc(sizeof(*comp));
  if (!comp) {
