 ...
 */
#define AIC_LVDS_LINK0_LANES                                                   \
  LVDS_LANES(LVDS_D3, LVDS_CK, LVDS_D2, LVDS_D1, LVDS_D0)
#define AIC_LVDS_LINK1_LANES                                                   \
  LVDS_LANES(LVDS_D3, LVDS_CK, LVDS_D2, LVDS_D1, LVDS_D0)
...
#define DE_DITHER_WIDTH_MAX 1920
#define DE_FREQ (70 * 1000 * 1000) /* 70MHz */

/* Layer configuration */
#define VI_LAYER_NUM 1
#define UI_LAYER_NUM 1
#define VI_LAYER_WIDTH_MAX 1920
#define VI_LAYER_HEIGHT_MAX 1080
#define UI_LAYER_WIDTH_MAX 1920
#define UI_LAYER_HEIGHT_MAX 1080

/* Display Engine timing constants */
#define LAYER_CONFIG_TIME_US 100 /* 100 microseconds */
...
#define AIC_RGB_FORMAT PRGB_24BIT
...
#define AIC_PQ_SET_DSIP_PINMUX aic_set_disp_pinmux_for_pq_tool()

#define AIC_PQ_TOOL_PINMUX_CONFIG(name)                                        \
  static struct disp_pinmux name[] = {                                         \
      {3, PIN_PULL_DIS, 3, "PD.8"},  {3, PIN_PULL_DIS, 3, "PD.9"},             \
      {3, PIN_PULL_DIS, 3, "PD.10"}, {3, PIN_PULL_DIS, 3, "PD.11"},            \
      {3, PIN_PULL_DIS, 3, "PD.12"}, {3, PIN_PULL_DIS, 3, "PD.13"},            \
      {3, PIN_PULL_DIS, 3, "PD.14"}, {3, PIN_PULL_DIS, 3, "PD.15"},            \
      {3, PIN_PULL_DIS, 3, "PD.16"}, {3, PIN_PULL_DIS, 3, "PD.17"},            \
  }

#define PANEL_DSI_SIMEP_SEND_SEQ panel_dsi_dcs_send_seq(panel, 0x00);
